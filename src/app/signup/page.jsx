    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Join AuctionHouse</h1>
          <p className="mt-2 text-sm text-gray-600">Create your account and start bidding today</p>
        </div>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <label className="relative flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <span className="font-medium text-gray-900">Buy & Bid</span>
                    <p className="text-gray-500">Participate in auctions</p>
                  </div>
                </label>
                <label className="relative flex items-start">
                  <div className="flex items-center h-5">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">Create auctions</p>
                  </div>
                </label>
              </div>
            </div>
