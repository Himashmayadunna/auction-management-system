      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-slate-800 hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors mb-3"
            >
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-md">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-gray-800">Demo Account</h3>
                <div className="mt-2 text-sm text-gray-600">
                  <p>Use any email and password to access the demo version.</p>
                </div>
                <div className="mt-3">
                  <button
                    type="button"
