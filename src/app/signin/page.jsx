      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center mb-4">
            <svg className="h-8 w-8 text-gray-900 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4h4a4 4 0 004-4V5z" />
            </svg>
            <span className="text-xl font-bold text-gray-900">AuctionHouse</span>
          </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-md leading-5 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                  required
                  disabled={loading}
                />
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-md">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-gray-800">Testing</h3>
                <div className="mt-2 text-sm text-gray-600">
                  <p>Use credentials from a registered account to sign in.</p>
                </div>
              </div>
            </div>
          </div>
