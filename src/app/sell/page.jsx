    ...
    <div className="min-h-screen bg-white text-gray-900 w-full m-0 p-0 font-sans">
      ...
      <div className="bg-white p-8 max-w-[800px] mx-auto my-8">
        ...
        <div className="max-w-[800px] mx-auto mb-8 text-center">
          ...
          <p className="text-xl text-gray-700 m-0">Photos, condition, specifications</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-8">
          ...
          <div className="flex justify-between mt-8">
            <button type="button" className="px-8 py-3 rounded border border-gray-300 bg-gray-100 text-gray-900 text-base">Previous</button>
